...
A1 <- as.matrix(read.table("../../results/Godoy/godoy.C.alphas.1.csv"))
A2 <- as.matrix(read.table("../../results/Godoy/godoy.C.alphas.2.csv"))
A3 <- as.matrix(read.table("../../results/Godoy/godoy.C.alphas.3.csv"))
...
pdf('../../manuscript/Figures/Axes/godoy.C.alphas.pdf', width=17, height=4.5)
