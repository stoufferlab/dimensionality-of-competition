...
# minimum value of resource availability
theta_min <- 0.01

cntr <- 1
res <- list()
for(resource in d:2){
	for(val in seq(0.5,theta_min,length.out=n_vals)){
...
p2 <- ggplot() +
	...
	geom_line(aes(x = seq(8000,9000,length.out=100), y = 2, alpha = seq(1,theta_min,length.out=100), linewidth=2)) +
	geom_line(aes(x = seq(1,7000,length.out=100), y = 3, alpha = 1, linewidth=2)) +
	geom_line(aes(x = seq(7000,8000,length.out=100), y = 3, alpha = seq(1,theta_min,length.out=100), linewidth=2)) +
	geom_line(aes(x = seq(8000,9000,length.out=100), y = 3, alpha = theta_min, linewidth=2)) +
	geom_line(aes(x = seq(1,6000,length.out=100), y = 4, alpha = 1, linewidth=2)) +
	geom_line(aes(x = seq(6000,7000,length.out=100), y = 4, alpha = seq(1,theta_min,length.out=100), linewidth=2)) +
	geom_line(aes(x = seq(7000,9000,length.out=100), y = 4, alpha = theta_min, linewidth=2)) +
	geom_line(aes(x = seq(1,5000,length.out=100), y = 5, alpha = 1, linewidth=2)) +
	geom_line(aes(x = seq(5000,6000,length.out=100), y = 5, alpha = seq(1,theta_min,length.out=100), linewidth=2)) +
	geom_line(aes(x = seq(6000,9000,length.out=100), y = 5, alpha = theta_min, linewidth=2)) +
	geom_line(aes(x = seq(1,4000,length.out=100), y = 6, alpha = 1, linewidth=2)) +
	geom_line(aes(x = seq(4000,5000,length.out=100), y = 6, alpha = seq(1,theta_min,length.out=100), linewidth=2)) +
	geom_line(aes(x = seq(5000,9000,length.out=100), y = 6, alpha = theta_min, linewidth=2)) +
	geom_line(aes(x = seq(1,3000,length.out=100), y = 7, alpha = 1, linewidth=2)) +
	geom_line(aes(x = seq(3000,4000,length.out=100), y = 7, alpha = seq(1,theta_min,length.out=100), linewidth=2)) +
	geom_line(aes(x = seq(4000,9000,length.out=100), y = 7, alpha = theta_min, linewidth=2)) +
	geom_line(aes(x = seq(1,2000,length.out=100), y = 8, alpha = 1, linewidth=2)) +
	geom_line(aes(x = seq(2000,3000,length.out=100), y = 8, alpha = seq(1,theta_min,length.out=100), linewidth=2)) +
	geom_line(aes(x = seq(3000,9000,length.out=100), y = 8, alpha = theta_min, linewidth=2)) +
	geom_line(aes(x = seq(1,1000,length.out=100), y = 9, alpha = 1, linewidth=2)) +
	geom_line(aes(x = seq(1000,2000,length.out=100), y = 9, alpha = seq(1,theta_min,length.out=100), linewidth=2)) +
	geom_line(aes(x = seq(2000,9000,length.out=100), y = 9, alpha = theta_min, linewidth=2)) +
	geom_line(aes(x = seq(1,1000,length.out=100), y = 10, alpha = seq(1,theta_min,length.out=100), linewidth=2)) +
	geom_line(aes(x = seq(1000,9000,length.out=100), y = 10, alpha = theta_min, linewidth=2)) +
	...
	scale_y_reverse(name = expression('Resource, '*italic(k)), breaks = 1:10) +
...
sapply(
	...
	function(i,c.list){
		...
		if(i == 1){
			...
			mtext(expression(bold(c)*' Interaction matrices, '*italic(A)), 3, xpd=NA, cex=2, adj=0, at = 0, line = -1)
		}
