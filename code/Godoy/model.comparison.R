...
model.formula.1 <- as.formula(paste0(fecundity," ~ 0 + target + neighbours_number"))
model.formula.2 <- as.formula(paste0(fecundity," ~ 0 + target + target:neighbours_number"))
model.formula.3 <- as.formula(paste0(fecundity," ~ 0 + target + target:background:neighbours_number"))
